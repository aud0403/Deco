...
<body>
  ...
  <div class="decoList">
    ...
    <div class="searchResult">Restaurant 찜목록</div>
    <section class="lists">
    <c:forEach var="vo" items="${dibsFood}" varStatus="status">
      <a class="list" href="food.deco?fidx=${vo.fidx}">
        <img src="/fimage/${vo.outimage}" onerror="this.src='img/기본이미지.png'" alt="food-out" class="img" width="150px" height="150px">
