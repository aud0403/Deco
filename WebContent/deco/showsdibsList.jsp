...
<body>
  ...
  <div class="decoList">
    ...
    <div class="searchResult">show 찜목록</div>
    <section class="lists">
    <c:forEach var="vo" items="${dibsShows}" varStatus="status">
      <a class="list" href="shows.deco?sidx=${vo.sidx}">
        <img src="/simage/${vo.outimage}" onerror="this.src='img/기본이미지.png'" alt="shows-out" class="img" width="150px" height="150px">
